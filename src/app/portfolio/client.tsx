...
const portfolioItems: PortfolioItem[] = [
  ...
  },
  {
    ...
    description: "Revitalized the church kitchen with a modern touch. We repainted and add clear sealer to the existing cupboards, transforming them into sleek, grey units that complement the industrial-style space.",
    images: ["d7mc0v", "xi0gy3", "qs3dco", "lfcviy", "eii8i2", "kvreig", "cp5w3n", "yjhunm"],
    category: "Modern",
  },
  {
    id: 9,
    title: "Patio Daybed Revival",
    description: "What began as a sun-bleached, weather-worn daybed destined for the scrap heap is now a solid, statement-making centerpiece. This coastal restoration project showcases the transformation from severe UV fading and loose joints to a rich honey-toned finish with rock-solid construction, perfect for coastal climates.",
    images: ["sunbed1", "sunbed2", "sunbed3", "sunbed4", "sunbed5", "sunbed6", "sunbed7", "sunbed8"],
    category: "Rustic",
    projectUrl: "/portfolio/patio-daybed-revival",
  },
  {
    id: 10,
    title: "Heritage Chest Make-Over",
    description: "A family-heirloom mahogany blanket chest transformed from tired and blotchy to a deep, glass-smooth showpiece. This restoration showcases expert finish removal, grain revival, custom dye staining, and museum-quality refinishing techniques that reveal stunning heartwood patterns.",
    images: ["chest1", "chest2", "chest3", "chest4", "chest5", "chest6", "chest7", "chest8"],
    category: "Antique",
    projectUrl: "/portfolio/heritage-chest-makeover",
  },
  {
    id: 11,
    ...
    images: ["limewash1", "limewash2", "limewash3", "limewash4", "limewash5", "limewash6", "limewash7"],
    category: "Modern",
