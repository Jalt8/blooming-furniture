...
export const metadata: Metadata = {
  ...
  keywords: 'furniture restoration FAQ, furniture repair questions, restoration cost, how long does restoration take, furniture restoration process, West Coast furniture FAQ',
  openGraph: {
...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How much does furniture restoration cost?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Furniture restoration costs vary depending on the piece, its condition, and the services needed. Each project is unique, so we provide free assessments and detailed quotes tailored to your specific furniture. Contact us for a personalized quote."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Most furniture restoration projects take 2-4 weeks, depending on complexity. Simple refinishing may take 1-2 weeks, while extensive restoration or custom work can take 4-6 weeks. We provide a timeline estimate with your quote."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes! We offer convenient collection and delivery throughout the West Coast region including Langebaan, Saldanha Bay, Vredenburg, Paternoster, and surrounding areas. Fees vary by location and are included in your quote."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "We restore all types of wood including oak, pine, teak, mahogany, yellowwood, stinkwood, and more. Our craftsmen have expertise with both local South African woods and imported hardwoods."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes! We repair structural damage, broken joints, loose hardware, water damage, scratches, dents, and more. Our craftsmen can rebuild missing parts and reinforce weak areas to ensure your furniture is sturdy and functional."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Absolutely! We specialize in antique furniture restoration using traditional techniques to preserve the authenticity and value of your heirloom pieces. We understand the importance of maintaining historical integrity while making pieces functional."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "We service the entire West Coast of South Africa including Langebaan, Saldanha Bay, Vredenburg, Paternoster, Velddrif, Hopefield, Yzerfontein, and Elands Bay. We may also service surrounding areas - contact us to confirm."
      }
    },
    {
      "@type": "Question",
      "name": "Can I choose custom colors for my furniture?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes! We offer a wide range of custom colors and finishes including natural wood stains, chalk paint in any color, distressed finishes, and various sheen levels from matte to high gloss. We can match any color you have in mind."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes! We stand behind our craftsmanship with a satisfaction guarantee. If there are any issues with our work, we'll make it right. We use high-quality materials and techniques designed to last for years."
      }
    },
    {
      "@type": "Question",
      "name": "How do I get a quote for my furniture restoration project?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Getting a quote is easy! Contact us via phone (079) 375 2588, WhatsApp, or our online form. Send photos of your furniture, describe the issues, and we'll provide a detailed estimate. We also offer free in-person assessments for complex projects."
      }
    }
  ]
};
    ...
    questions: [
      {
        ...
        a: "Project timelines vary based on complexity and our current workload:",
        details: [
          "Simple refinishing: 1-2 weeks",
          "Standard restoration: 2-4 weeks",
          "Complex/antique restoration: 4-6 weeks",
          "Rush service: Available with surcharge"
        ],
        note: "We'll provide a specific timeline with your quote and keep you updated throughout the process."
      },
      {
    ...
    questions: [
      ...
      },
      {
        ...
        details: [
          ...
          "♻️ Eco-friendly products and practices",
