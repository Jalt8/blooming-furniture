          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <section id="coastal-threats" className="mb-12">
              ...
              <div className="prose max-w-none">
                <p className="text-lg text-forest-green leading-relaxed mb-6">Understanding what you are fighting against is the first step to winning. The West Coast of South Africa presents four distinct threats to wooden furniture, and each requires a specific response. At <Link href="/coastal-furniture-protection" className="text-dark-wood font-semibold hover:underline">Blooming Furniture</Link>, we see the effects of these threats daily and have developed proven strategies to combat each one.</p>
              </div>
            ...
            <section id="professional-care" className="mb-12">
              ...
              <p className="text-forest-green mb-6 leading-relaxed">Regular maintenance can be done at home, but some situations require professional intervention. At <Link href="/salt-damaged-furniture-repair" className="text-dark-wood font-semibold hover:underline">Blooming Furniture</Link>, we specialise in coastal furniture restoration and see these issues regularly.</p>
              <div className="space-y-4">
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                  <h3 className="text-lg font-bold text-dark-wood mb-2">Significant salt or water damage</h3>
                  <p className="text-forest-green">When salt has penetrated the finish and is affecting the wood underneath, or when water damage has caused swelling, warping, or white marks, professional <Link href="/salt-damaged-furniture-repair" className="text-dark-wood font-semibold hover:underline">salt damage repair</Link> is needed to properly strip, treat, and refinish the piece.</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                  <h3 className="text-lg font-bold text-dark-wood mb-2">Sun fading and UV damage</h3>
                  <p className="text-forest-green">Severe UV damage causes finishes to crack, wood to bleach unevenly, and joints to weaken. <Link href="/sun-faded-furniture-restoration" className="text-dark-wood font-semibold hover:underline">Sun faded furniture restoration</Link> involves stripping the damaged finish, evening out the colour, and applying a UV-resistant protective finish.</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-6">
