          ...
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <Link href="/antique-restoration" className="block p-4 bg-daisy-cream rounded-lg shadow hover:shadow-md transition">
                <h3 className="font-semibold text-forest-green">Antique Restoration</h3>
                <p className="text-sm text-dark-wood mt-1">Specialist restoration preserving the character of antique furniture</p>
              </Link>
            </div>
          </div>
        </section>
